...
static int CHAR_COUNT_INDICATOR_SIZE[NUM_VERSION+1][NUM_QRMODE] = {//Character Count Indicator
        {-1, -1, -1, -1},
...
static int NUMERIC_CHAR_LIST[NUMERIC_CHAR_SIZE] =  {0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39}; // numeric: {0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39}
static int ALPHANUMERIC_CHAR_LIST[ALPHANUMERIC_CHAR_SIZE] = {
...
static int erdata_size[NUM_VERSION][NUM_ECLEVEL] = {
    {19,16,13,9},
    {34,28,22,16},
    {55,44,34,26},
    {80,64,48,36},
